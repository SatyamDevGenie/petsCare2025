      ...
      <Card>
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            {current.contactNumber && <p className="text-gray-600 mt-2">Contact: {current.contactNumber}</p>}
            {current.notes && <p className="text-gray-600 mt-4 leading-relaxed">{current.notes}</p>}
          </div>
        </div>
      </Card>
    </div>
