...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <p className="text-slate-600 mb-8">Welcome, {user?.name}.</p>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Link to="/admin/appointments">
          <Card className="hover:shadow-md hover:border-primary-200 transition h-full">
            ...
            <p className="text-sm text-slate-600">{appointments?.length ?? 0} total, {pending} pending</p>
          </Card>
        </Link>
        <Link to="/admin/pets">
          <Card className="hover:shadow-md hover:border-primary-200 transition h-full">
            ...
            <p className="text-sm text-slate-600">Manage pets</p>
          </Card>
        </Link>
        ...
        <Link to="/admin/doctors">
          <Card className="hover:shadow-md hover:border-primary-200 transition h-full">
            ...
            <p className="text-sm text-slate-600">Manage doctors</p>
          </Card>
        </Link>
      </div>
